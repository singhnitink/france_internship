...
data=np.genfromtxt('sec_st_3.dat',dtype=None,encoding=None,delimiter='')
file1=open('perframe_3.dat','w') #contains helixaverage of 5ns 250 frames
...
file2=open('helixaverage_3.dat','w') #contains helixaverage every 5ns ie. 250 frames
t2=t1+interval
m=0
...
while n<=len(H):
    ...
    file2.write('%d\t%d\t 3 \t%.2f\t%.2f\t%.2f\t'%(t1,t2,mean_allhelix,std_allhelix,median_allhelix))
